...
const sendEmail = async(data) => {
    ...
    try {
        ...
        const selfMailOptions = {
            from: `VPS Services<${process.env.MAIL_USERNAME}>`,
                ...
                <div style="background-color: #f4f4f4; padding: 10px;">
                    <div style="max-width: 600px; margin: 0 auto;">
                        <div style="background-color: #fff; padding: 20px; text-align: start; border-radius: 15px; box-shadow: 0px 0px 10px rgba(0,0,0,0.1);">
                            ...
                            <p style="font-size: 16px; color: #666;">A new user has sent a query. Below are the details:  <img src="https://res.cloudinary.com/duvnz67bv/image/upload/v1711568483/Ecommerce/uvolj2occmpavtzedke4.png" alt="Project Logo" style="max-width: 100px; margin-top: 20px;"></p>
                            ...
                            <p style="font-size: 16px; color: #666;">Thanks,<br>Ecommerce</p>
        ...
        const userMailOptions = {
            from: `Emoomece<${process.env.MAIL_USERNAME}>`,
            to: email,
            ...
            <body style="font-family: Arial, sans-serif; margin: 0 auto; padding: 0;">
                <div style="background-color: #f4f4f4; padding: 10px;">
                    <div style="max-width: 600px; margin: 0;">
                        <div style="background-color: #fff; padding: 20px; text-align: start; border-radius: 15px; box-shadow: 0px 0px 10px rgba(0,0,0,0.1);">
                            <h2 style="color: #444; font-size: 24px;">🎉 We Received Your Query <img src="https://res.cloudinary.com/duvnz67bv/image/upload/v1711568483/Ecommerce/uvolj2occmpavtzedke4.png" alt="Project Logo" style="max-width: 100px; margin-top: 20px;"></h2>
                            ...
                            <p style="font-size: 16px; color: #666;">Best,<br>Ecommerce VPS services</p>
